        ...
        <div class="container-fluid">
			<ol class="breadcrumb">
				<li><a href="../admin_tc">   
					...
					&ensp; </a> </li>
				<li class="active" style="font-size: 20px; color:lightskyblue">  Khách hàng</li>
			</ol>
				<h1 class="page-header" style="margin-top: -20px; margin-bottom :0px;">Quản lý Khách hàng</h1> 
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
						<div class="the_a"> <a href="../custommer/list_addcategory" class="submit"  style="text-decoration: none">Thêm Khách hàng</a></div>
                        </div>
                        <div class="body">
							...
							<table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                        <tr >
                                            ...
                                            <th style="width:12%; text-align: center;">Tên khách hàng</th>
                                            <th style="width:15%;text-align: center;">Mã QR</th>
                                            <th style="width:10%;text-align: center;">Số điện thoại</th>
                                            <th style="width:8%;text-align: center;">Email</th>
                                    ...
                                    <tbody>
										...
										<td>
										<div id="qrcode<?php echo $i ?>" class="qrcode" style="margin-left: 0%; ">
                    					</div>
										</td>
										...
										<td><?php 
											$xa = $client['name']; 
											$diachi = $client['address_client'];
											$quanhuyen = $client['name_quanhuyen'];
											$thanhpho = $client['name_tinhthanh'];
											$gt= $diachi.' '.$xa.' '. $quanhuyen .' '. $thanhpho;
											echo $gt;
										
										?></td>
										<td><a href="../custommer/list_updatecategory/<?php echo $client['id_client'] ?>">Cập nhập</a></td>
										<td></td>
										</tr>
										<?php
											$i++;
...
<script type="text/javascript" src="../../QR_Project/createQR/jquery.min.js"></script>
	  ...
	  <script type="text/javascript">
		var i = '<?php echo  count($kh); ?>';
		var id_client = new Array();

		var js_array = [<?php echo '"'.implode('","', $client_id).'"' ?>];
