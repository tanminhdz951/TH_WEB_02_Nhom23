...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li  class="active"><a href="admin_tc"><em class="fa fa-dashboard">&nbsp;</em>Trang chủ</a></li>
	...
	<script src="../app/views/admin/js/jquery-1.11.1.min.js"></script>
	<script src="../app/views/admin/js/bootstrap.min.js"></script>
	<script src="../app/views/admin/js/chart.min.js"></script>
	<script src="../app/views/admin/js/chart-data.js"></script>
	<script src="../app/views/admin/js/easypiechart.js"></script>
	<script src="../app/views/admin/js/easypiechart-data.js"></script>
	<script src="../app/views/admin/js/bootstrap-datepicker.js"></script>
	<script src="../app/views/admin/js/custom.js"></script>
	<script>
