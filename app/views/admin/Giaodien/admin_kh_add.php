...
<body>
	...
	<div style="margin-top:10px">
			...
			<li><a href="../admin_tc" style="text-decoration: none;">   
				...
				<li class="active" style="font-size: 20px; color:lightskyblue; display: flex;"> <p style="color: gray;font-size:20px;">&ensp;&#62;&ensp; </p> Thêm Khách hàng</li>
			</ol>
			<h1 class="page-header" style="margin-top: 0px; margin-bottom :0px;font-weight: bold;">Quản lý Khách hàng</h1> 
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							...
							<form role="form" action="../custommer/insert_category" method="POST">
								<div class="form-group">
									<label>Tên khách hàng</label>
									<input name ="name_client" class="form-control">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Email</label>
									<input name="email_client" class="form-control" >
								</div>
								<div class="form-group">
									<label>Số điện thoại</label>
									<input name="phone_client" class="form-control" >
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Địa chỉ</label>
									<input name="address_client" class="form-control" >
								</div>
								<div class="form-group">
    ...
    function makeCode () {        
      var elText ='http://localhost/myweb/Do_an_web_2/category/list_updatecategory/'+'<?php echo 20?>'
