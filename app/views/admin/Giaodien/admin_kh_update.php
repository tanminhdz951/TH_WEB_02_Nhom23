...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="../../custommer/list_category"><em class="fa fa-toggle-off">&nbsp;</em>Khách hàng</a></li>
	...
	<div style="margin-top:10px">
			...
			<li><a href="../admin_tc" style="text-decoration: none;">   
				...
				<li class="active" style="font-size: 20px; color:lightskyblue; display: flex;"> <p style="color: gray;font-size:20px;">&ensp;&#62;&ensp; </p><a href="../custommer/list_category" style="text-decoration: none;"> Khách hàng</a></li>
				<li class="active" style="font-size: 20px; color:lightskyblue; display: flex;"> <p style="color: gray;font-size:20px;">&ensp;&#62;&ensp; </p> Cập nhập khách hàng</li>
			</ol>
			<h1 class="page-header" style="margin-top: 0px; margin-bottom :0px;font-weight: bold;">Thông tin khách hàng</h1> 
				...
				<div class="panel panel-default" style="display: flex;">
					...
					<div class="panel-body" style="width:80%">
						<div class="col-md-6" style="width:65%; padding-right: 5px; padding-left: 5px; margin-right: 5%;">
                            <?php 
                                    foreach ($KH as $key => $client){
                                ?>
							<form role="form" action="../../custommer/update_category/<?php echo $client['id_client'] ?>" method="POST">
                               
								<div class="form-group">
									<label>Tên Nhân viên</label>
									<input name ="name_staff" class="form-control" value="<?php echo $client['name_client'] ?>" >
								</div>
								<div class="form-group">
									<label>Tên Đăng nhập</label>
									<input name ="user_name" class="form-control" disabled value="<?php echo $client['username']?>">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<select name = "quanhuyen" class="quanhuyen form-control" id=QuanHuyen >
										<option value="<?php echo $client['maqh']; ?>"> <?php echo $client['name_quanhuyen']; ?></option>
									</select>
								</div>
								<div class="form-group">
								<label>Xã phường</label>
								<select name = "phuongxa" class="phuongxa form-control" id="PhuongXa">
                                    <option value="<?php echo $client['xaid']; ?>"> <?php echo $client['name']; ?></option>
								...
								<div class="form-group">
									<label>Địa chỉ</label>
									<input name="address_staff" class="form-control" value="<?php echo $client['address_client'] ?>" >
								</div>
                                <?php
                                    }
                                ?>
                    ...
                    <div class="col-md-6" style="width :55% ; margin-top:1%; padding-right: 5px; padding-left: 5px; margin-right: 5%"> 
                        <div class="form-group">
                            <label>Email</label>
                            <input name="email_staff" class="form-control" value="<?php echo $client['email_client'] ?>" >
                        </div>
                        <div class="form-group">
                            <label>Số điện thoại</label>
                            <input name="phone_staff" class="form-control" value="<?php echo $client['phone_client'] ?>">
                        </div>
						<div class="page" id="print">
                			<div class="row">
                  				<div class="col s12">
                        			<div  style="border: 2px solid #000; border-radius: 5px; width: 55%;  ">
...
<script type="text/javascript" src="../../../QR_Project/createQR/jquery.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    function makeCode () {        
      var elText ='http://localhost/myweb/Do_an_web_2/category/list_updatecategory/'+'<?php echo $client['id_client'] ?>'
