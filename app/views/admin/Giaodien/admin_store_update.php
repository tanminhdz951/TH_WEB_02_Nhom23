...
<body>
	...
	<div style="margin-top:10px">
			...
			<li><a href="../admin_tc" style="text-decoration: none;">   
				...
				<li class="active" style="font-size: 20px; color:lightskyblue; display: flex;"> <p style="color: gray;font-size:20px;">&ensp;&#62;&ensp; </p> Cập nhập cửa hàng</li>
			</ol>
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default" style="display: flex;">
					...
					<div class="panel-body" style="width:80%">
						<div class="col-md-6" style="width:65%; padding-right: 5px; padding-left: 5px; margin-right: 5%;">
                            <?php 
                                ...
                                ?>
							<form role="form" action="../../store/update_category/<?php echo $store['id_store'] ?>" method="POST">
                               
								<div class="form-group">
									<label>Tên cửa hàng</label>
									<input name ="name_store" class="form-control" value="<?php echo $store['name_store'] ?>" >
								</div>
								...
								<div class="form-group">
									...
									<select name = "quanhuyen" class="quanhuyen form-control" id=QuanHuyen >
										<option value="<?php echo $store['maqh']; ?>"> <?php echo $store['name_quanhuyen']; ?></option>
									</select>
								</div>
								<div class="form-group">
								<label>Xã phường</label>
								<select name = "phuongxa" class="phuongxa form-control" id="PhuongXa">
                                    <option value="<?php echo $store['xaid']; ?>"> <?php echo $store['name']; ?></option>
								...
								<div class="form-group">
									<label>Địa chỉ</label>
									<input name="address_store" class="form-control" value="<?php echo $store['address_store'] ?>" >
								</div>
                                <?php
                                    }
                                ?>
                    ...
                    <div class="col-md-6" style="width :55% ; margin-top:1%; padding-right: 5px; padding-left: 5px; margin-right: 5%"> 
                        <div class="form-group">
                            <label>Email</label>
                            <input name="email_store" class="form-control" value="<?php echo $store['email_store'] ?>" >
                        </div>
                        <div class="form-group">
                            <label>Số điện thoại</label>
                            <input name="phone_store" class="form-control" value="<?php echo $store['phone_store'] ?>">
                        </div>
